...
import { type AddressSchema, type RegistrationSchema, registrationSchema } from '../../lib/schemas';
    ...
    <div className={classes.wrapper}>
      <TabList selectedValue={selectedValue} onTabSelect={onTabSelect}>
        <Tab
          value={'personal'}
          icon={<PersonRegular />}
          disabled={!!errors.shipping || (shippingAsBilling && !!errors.billing)}
        >
          Personal
        </Tab>
        <Tab
          value={'shipping'}
          icon={<LocationFilled />}
          disabled={step < 1 || !!errors.personal || (!!errors.billing && shippingAsBilling)}
        >
          Shipping
        </Tab>
        <Tab
          ...
          disabled={shippingAsBilling || step < 2 || !!errors.personal || !!errors.shipping}
        >
          Billing
        </Tab>
      </TabList>
        ...
        >
          <div hidden={selectedValue !== 'personal'}>
            <div className={classes.group}>
              ...
              <FormFieldInput
                ...
                contentBefore={<PersonCircleRegular className={classes.before} />}
              ...
              <FormFieldInput
                ...
                contentBefore={<PersonCircleFilled className={classes.before} />}
              ...
              <FormFieldDatePicker
                ...
                contentBefore={<CalendarAddRegular className={classes.before} />}
                contentAfter={<span />}
          ...
          <div hidden={selectedValue !== 'shipping'}>
            <div className={classes.group}>
              ...
              <FormFieldInput
                label={
                  <InfoLabel info={shippingPcFormat && `format: ${shippingPcFormat}`}>
                    Postal Code
                  </InfoLabel>
                }
            ...
            <Button
              type="submit"
              appearance="primary"
              icon={shippingAsBilling ? <SendRegular /> : <DocumentArrowRightRegular />}
            ...
            <div>
              {fields.map((field, index) => (
                <div className={classes.group} key={field.id}>
                  ...
                  <FormFieldInput
                    label={
                      <InfoLabel info={billingPcFormat && `format: ${billingPcFormat}`}>
                        Postal Code
                      </InfoLabel>
                    }
                    placeholder="type postcode here..."
