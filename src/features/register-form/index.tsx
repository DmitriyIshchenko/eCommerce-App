...
import { type RegisterSchema, registerSchema } from "../../lib/schemas/user";
...
import { DEFAULT_ADDRESS, TOASTER_ID } from "../../lib/constants/constants";
...
export default function RegisterForm() {
	...
	const [isDefaultBillingAddress, setIsDefaultBillingAddress] =
		useState<CheckboxProps["checked"]>(false);
	const [shippingAsBilling, setShippingAsBilling] =
		useState<CheckboxProps["checked"]>(false);
