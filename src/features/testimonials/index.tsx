      ...
      <div className={css.right}>
        ...
        >
          ...
          >
            ...
            <div>
              <p>Dan Abramov</p>
              <p style={{ color: tokens.colorNeutralForeground4 }}>London, UK</p>
            </div>
          </CardFooter>
        </Card>
        <Card
        ...
        >
          ...
          >
            ...
            <div>
              <p>Leah Verou</p>
              <p style={{ color: tokens.colorNeutralForeground4 }}>Cambridge, Massachusetts</p>
            </div>
          </CardFooter>
        </Card>
        <Card
        ...
        >
          ...
          >
            ...
            <div>
              <p>Ryan Dahl</p>
              <p style={{ color: tokens.colorNeutralForeground4 }}>San Diego, California</p>
            </div>
          </CardFooter>
        </Card>
        <Card
        ...
        >
          ...
          >
            ...
            <div>
              <p>Brandon Eich</p>
              <p style={{ color: tokens.colorNeutralForeground4 }}>San Francisco, California</p>
            </div>
          </CardFooter>
        </Card>
        <Card
